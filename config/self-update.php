...
return [
    ...
    */
    ...
    'notifications' => [
        'notifications' => [
            \NawrasBukhari\Updater\Notifications\Notifications\UpdateSucceeded::class => ['mail'],
            \NawrasBukhari\Updater\Notifications\Notifications\UpdateFailed::class => ['mail'],
            \NawrasBukhari\Updater\Notifications\Notifications\UpdateAvailable::class => ['mail'],
        ],
         ...
         */
        'notifiable' => \NawrasBukhari\Updater\Notifications\Notifiable::class,
